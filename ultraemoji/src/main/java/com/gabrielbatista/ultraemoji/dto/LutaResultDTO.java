...
public class LutaResultDTO {
    ...
    public String getLutador1Nome() {
        return lutador1Nome;
    }

    public void setLutador1Nome(String lutador1Nome) {
        this.lutador1Nome = lutador1Nome;
    }

    public String getLutador2Nome() {
        return lutador2Nome;
    }

    public void setLutador2Nome(String lutador2Nome) {
        this.lutador2Nome = lutador2Nome;
    }
    ...
    public void setVencedorNome(String vencedorNome) {
        this.vencedorNome = vencedorNome;
    }
}
